...
function AdminDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 admin-dashboard-stats">
        <StatsCard
          title="Total Views"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-8 admin-dashboard-grid">
